...
import com.github.rusichpt.customerapp.client.payload.NewProductReviewPayloadClient;
...
public class WebClientProductReviewService implements ProductReviewService {
    ...
    public Mono<ProductReview> createProductReview(Integer productId, Integer rating, String review) {
        return webClient
                ...
                .bodyValue(new NewProductReviewPayloadClient(productId, rating, review))
                .retrieve()
